...
def glmnet(*, x, y, family='gaussian', **options):
	...
	######debug
        #print('from glmnet.py print mtype',mtype,type(mtype))
        #print('from glmnet.py print indxtf',indxtf,type(indxtf))
        #print('from glmnet.py print indm:',indm,type(indm))
	#####debug
        if len(indm) == 0:
        ...
        ####bug!!!elif (indm == 2):
            ...
            kopt = 2
        ####debug
        print('from glmnet.py print kopt:',kopt,type(kopt))
    #
